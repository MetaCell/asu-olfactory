...
def ingest():  # noqa: E501
    ...
    task_ingest = tasks.CustomTask('ingest', 'pub-chem-index-ingestion', shared_directory=shared_directory, pod_context=operations.PodExecutionContext(key='app', value='pubchem-db', required=True))
